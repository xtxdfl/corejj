...
class About extends React.Component {
  ...
  componentDidMount() {
    ...
    http.get(`https://api.corejj.cc/apis/release/latest/?version=${VERSION}`)
      .then(res => {
        if (res.has_new) {
          notification.open({
            key: 'new_version',
            ...
            icon: <SmileTwoTone/>,
            btn: <a target="_blank" rel="noopener noreferrer" href="https://ops.corejj.cc/docs/update-version/">如何升级？</a>,
    ...
    return (
      <Spin spinning={fetching}>
        ...
        <Descriptions column={1}>
          ...
          <Descriptions.Item label="Spug API版本">{info['corejj_version']}</Descriptions.Item>
          <Descriptions.Item label="Spug Web版本">{VERSION}</Descriptions.Item>
          <Descriptions.Item label="官网文档">
            <a href="https://corejj.cc" target="_blank" rel="noopener noreferrer">https://corejj.cc</a>
          </Descriptions.Item>
          <Descriptions.Item label="更新日志">
            <a href="https://ops.corejj.cc/docs/change-log/" target="_blank"
               rel="noopener noreferrer">https://ops.corejj.cc/docs/change-log/</a>
          </Descriptions.Item>
        </Descriptions>
        {info['corejj_version'] !== VERSION && (
