...
import logo from 'layout/logo-corejj-txt.png';
        ...
        if (data['required_mfa']) {
          ...
          Modal.warning({
            ...
            content: <div>
              ...
              <a target="_blank"
                 href="https://ops.corejj.cc/docs/practice/"
    ...
    <div className={styles.container}>
      ...
      <div className={styles.footerZone}>
        <div className={styles.linksZone}>
          <a className={styles.links} title="官网" href="https://corejj.cc" target="_blank"
             rel="noopener noreferrer">官网</a>
          <a className={styles.links} title="Github" href="https://github.com/opencorejj/corejj" target="_blank"
